using Emne3GetAcademyOppgaver.Assignments.Assignment328A;
...
public class Tests
{
    ...
    public void Test01WaterAt20Degrees()
    {
        ...
        Assert.AreEqual(WaterState.Fluid.ToString(), water.State);
    ...
    {
        var water = new Water(50, -20);
        Assert.AreEqual(WaterState.Ice.ToString(), water.State);
        Assert.AreEqual(-20, water.Temperature);
    }
    ...
    public void Test03WaterAt120Degrees()
    {
        ...
        Assert.AreEqual(WaterState.Gas.ToString(), water.State);
    ...
    public void Test05WaterAt100Degrees()
    {
        ...
        Assert.AreEqual(WaterState.FluidAndGas.ToString(), water.State);
    ...
    public void Test10AddEnergy3()
    {
        ...
        Assert.AreEqual(WaterState.IceAndFluid.ToString(), water.State);
